...
## What is the maximum resolution of the images that LFS can train?
The maximum resolution for images is 16777216 pixels, which is 4096x4096 pixels.
If your images are above 4096 pixels in width, by default, LFS will rescale them to a maximum width of 4096.  To improve speed, we recommend to rescale the images when exporting to colmap format.
